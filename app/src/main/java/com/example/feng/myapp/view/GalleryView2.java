...
public class GalleryView2 extends Gallery
{
	...
	public GalleryView2(Context context)
	{
		super(context);
		this.setStaticTransformationsEnabled(true);
	}

	public GalleryView2(Context context, AttributeSet attrs)
	{
		super(context, attrs);
		this.setStaticTransformationsEnabled(true);
	}

	public GalleryView2(Context context, AttributeSet attrs, int defStyle)
	{
